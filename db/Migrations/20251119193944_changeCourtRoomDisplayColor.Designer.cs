...
namespace CAS.DB.Migrations
{
    ...
    [Migration("20251119193944_changeCourtRoomDisplayColor")]
    partial class changeCourtRoomDisplayColor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAS.API.Models.DB.Location", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Vancouver Island Virtual Registry (VIVR)",
                            RegionId = 1,
                            Timezone = "America/Vancouver"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Vancouver Island Regional HQ",
                            RegionId = 1,
                            Timezone = "America/Vancouver"
                        });
                });
            ...
            modelBuilder.Entity("CAS.DB.models.auth.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ConcurrencyToken = 0u,
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Generate Reports based on CourtAdmin's activity",
            ...
            modelBuilder.Entity("CAS.DB.models.courtAdmin.CourtAdminActingRank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CourtAdminActingRank");
                });
